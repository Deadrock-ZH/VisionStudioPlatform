...
namespace SvDistancePointPointTool
{
    ...
    /// 时 间：2021/5/14
    /// </summary>
    public partial class SvDistancePointPointToolForm : Form
    {
        /// <summary>
        /// 方法类
        /// </summary>
        public SvDistancePointPointToolMethod m_DistancePointPointToolMethod = null;// new SvAngleLXMethod();
        ...
        /// 构造函数
        /// </summary>
        public SvDistancePointPointToolForm()
        {
            InitializeComponent();
        }
        ...
        private void SvAngleLXForm_Load(object sender, EventArgs e)
        {
            ...
            if (null != m_DistancePointPointToolMethod.InputImage)
            {
                HOperatorSet.CopyImage(m_DistancePointPointToolMethod.InputImage, out m_hoImage);
            ...
            {
                if (cmb_Row1.Items[i].ToString().Contains(m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Row1SelectIndexName))
                {
            ...
            {
                if (cmb_Row2.Items[i].ToString().Contains(m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Row2SelectIndexName))
                {
            ...
            {
                if (cmb_Col1.Items[i].ToString().Contains(m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Col1SelectIndexName))
                {
            ...
            {
                if (cmb_Col2.Items[i].ToString().Contains(m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Col2SelectIndexName))
                {
            ...
            tsp_time.Text = m_DistancePointPointToolMethod.RunTime.ToString() + "ms";
            tsp_Msg.Text = m_DistancePointPointToolMethod.RunMsg;
        }
        ...
        {
            chk_Point1.Checked = m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Point1State;
            chk_Point2.Checked = m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Point2State;
            chk_Line.Checked = m_DistancePointPointToolMethod.SvDistancePointPointToolParas.LineState;
            chk_Standard.Checked = m_DistancePointPointToolMethod.SvDistancePointPointToolParas.StandardLineState;
            chk_Middle.Checked = m_DistancePointPointToolMethod.SvDistancePointPointToolParas.MiddlePointState;
        }
        ...
        private void UpdateInputeData()
        {
            ...
            if (m_DistancePointPointToolMethod.ListParaResultAll.Count > 0)
            {
                foreach (ParasResultAll item in m_DistancePointPointToolMethod.ListParaResultAll)
                {
        ...
        private void Cmb_Row1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            num_Row1.Value = d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Row1 = (double)d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Row1SelectIndexName = cmb_Row1.Text.Trim().Substring(0, cmb_Row1.Text.Trim().LastIndexOf('_'));
        }
        ...
        private void Cmb_Row2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            num_Row2.Value = d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Row2 = (double)d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Row2SelectIndexName = cmb_Row2.Text.Trim().Substring(0, cmb_Row2.Text.Trim().LastIndexOf('_'));
        }
        ...
        private void Cmb_Col1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            num_Col1.Value = d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Col1 = (double)d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Col1SelectIndexName = cmb_Col1.Text.Trim().Substring(0, cmb_Col1.Text.Trim().LastIndexOf('_'));
        }
        ...
        private void Cmb_Col2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            num_Col2.Value = d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Col2 = (double)d;
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Col2SelectIndexName = cmb_Col2.Text.Trim().Substring(0, cmb_Col2.Text.Trim().LastIndexOf('_'));
        }

        // run
        private void tsp_Run_Click(object sender, EventArgs e)
        {
            bool bstate = m_DistancePointPointToolMethod.Run();
        ...
        private void UpdateResultPara()
        {
            ...
            dgv_Result.Rows[0].Cells[1].Value = m_DistancePointPointToolMethod.Distance;
            dgv_Result.Rows[0].Cells[2].Value = m_DistancePointPointToolMethod.Row;
            dgv_Result.Rows[0].Cells[3].Value = m_DistancePointPointToolMethod.Col;
        }
        ...
        {
            m_Disp.HobjectToHimage(m_hoImage);
            if (m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Point1State)
            {
                m_Disp.DispObj(m_DistancePointPointToolMethod.Cross1, "red");
            }
            if (m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Point2State)
            {
                m_Disp.DispObj(m_DistancePointPointToolMethod.Cross2, "red");
            }
            if (m_DistancePointPointToolMethod.SvDistancePointPointToolParas.LineState)
            {
                m_Disp.DispObj(m_DistancePointPointToolMethod.Line, "red");
            }
            if (m_DistancePointPointToolMethod.SvDistancePointPointToolParas.StandardLineState)
            {
                m_Disp.DispObj(m_DistancePointPointToolMethod.CenterLine, "green");
            }
            if (m_DistancePointPointToolMethod.SvDistancePointPointToolParas.MiddlePointState)
            {
                m_Disp.DispObj(m_DistancePointPointToolMethod.CrossCenter, "green");
            }
        }
        ...
        {
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Point1State = chk_Point1.Checked;
            UpdateRegResult();
        }
        ...
        {
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.Point2State = chk_Point2.Checked;
            UpdateRegResult();
        }
        ...
        {
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.LineState = chk_Line.Checked;
            UpdateRegResult();
        }
        ...
        {
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.StandardLineState = chk_Standard.Checked;
            UpdateRegResult();
        }

        private void chk_Middle_CheckedChanged(object sender, EventArgs e)
        {
            m_DistancePointPointToolMethod.SvDistancePointPointToolParas.MiddlePointState= chk_Middle.Checked ;
            UpdateRegResult();
        }
    }
}
